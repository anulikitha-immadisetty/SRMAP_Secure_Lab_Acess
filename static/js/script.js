let video;
let canvas;
let nameInput; // Added semicolon to end the statement
...
function init() {
    ...
    navigator.mediaDevices.getUserMedia({ video: true })
        ...
        .catch(error => { // Changed "err" to "error" in the catch block
            console.log("Error accessing webcam", error); // Changed "error" to "err" in the console.log message
